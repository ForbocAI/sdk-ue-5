...
/**
 * User Story: As Ghost vector evidence storage, I need actor, observation, and optional type parsed before one Ghost SDK memory operation.
 * @fn inline GhostResult StoreGhostMemory( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::Ghost::FCLIGhostState &GhostState, const ForbocAI::CLI::NPC::FCLINPCState &ActorState, const ForbocAI::CLI::Memory::FCLIMemoryState &MemoryState, int32 First, int32 Second)
 */
...
/**
 * User Story: As Ghost decision making, I need ordinary decision arguments delegated only to the Ghost SDK process operation and API-owned analytical results rendered verbatim.
 * @fn inline GhostResult DecideGhost( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::Ghost::FCLIGhostState &GhostState, const ForbocAI::CLI::NPC::FCLINPCState &ActorState, int32 First, int32 Second)
 */
            ...
            [&]() {
              ...
              const TArray<FString> Lines =
                  ForbocAI::CLI::Analysis::selectAgentResponseLines(
                      Response, ActorState,
                      formatCliMessage(ActorState.Messages.Dialogue,
                                       Dialogue),
              ...
              return CLIOps::CommandResult::Success(
                  ForbocAI::CLI::Analysis::serializeAgentResponseLines(
                      Lines, ActorState));
            },
            [&]() {
              return CLIOps::CommandResult::Failure(
