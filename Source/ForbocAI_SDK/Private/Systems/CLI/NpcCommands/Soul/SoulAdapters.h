...
/**
 * User Story: As NPC soul import, I need one transaction identifier delegated to the SDK soul operation and its result rendered.
 * @fn inline NpcResult ImportNpc( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::NPC::FCLINPCState &State, int32 First)
 */
