...
/**
 * User Story: As NPC creation, I need the CLI to validate and present one SDK actor creation operation.
 * @fn inline NpcResult CreateNpc( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::NPC::FCLINPCState &State, int32 First)
 */
...
/**
 * User Story: As NPC hydration, I need the CLI to present one SDK actor/vector recall operation.
 * @fn inline NpcResult RecallNpc( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::NPC::FCLINPCState &State, int32 First)
 */
...
/**
 * User Story: As NPC state inspection, I need explicit or active actor state selected by one SDK operation and rendered by the CLI.
 * @fn inline NpcResult PrintNpcState( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::NPC::FCLINPCState &State, int32 First)
 */
...
/**
 * User Story: As NPC state mutation, I need CLI options decoded once and delegated to the SDK for target resolution and reduction.
 * @fn inline NpcResult UpdateNpc( rtk::EnhancedStore<FRuntimeState> &Store, const TArray<FString> &Args, const ForbocAI::CLI::NPC::FCLINPCState &State)
 */
