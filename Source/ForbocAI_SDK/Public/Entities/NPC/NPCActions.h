 ...
 * @fn inline const rtk::ActionCreator<FSetNPCInfoPayload> &setNPCInfoActionCreator()
 */
inline const rtk::ActionCreator<FSetNPCInfoPayload> &setNPCInfoActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FSetNPCInfoPayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FSetNPCInfoPayload> {
        return rtk::createAction<FSetNPCInfoPayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV4C43CFDED912));
      });
 ...
 * @fn inline const rtk::ActionCreator<FString> &setActiveNPCActionCreator()
 */
inline const rtk::ActionCreator<FString> &setActiveNPCActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FString>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FString> {
        return rtk::createAction<FString>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV5361F8DE574F));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FSetNPCStatePayload> & setNPCStateActionCreator()
 */
...
setNPCStateActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FSetNPCStatePayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FSetNPCStatePayload> {
        return rtk::createAction<FSetNPCStatePayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV8EB05681C554));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FUpdateNPCStatePayload> & updateNPCStateActionCreator()
 */
...
updateNPCStateActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FUpdateNPCStatePayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FUpdateNPCStatePayload> {
        return rtk::createAction<FUpdateNPCStatePayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV2AB6F661B7B4));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FAddToHistoryPayload> & addToHistoryActionCreator()
 */
...
addToHistoryActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FAddToHistoryPayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FAddToHistoryPayload> {
        return rtk::createAction<FAddToHistoryPayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV414F28EA260A));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FSetHistoryPayload> &setHistoryActionCreator()
 */
inline const rtk::ActionCreator<FSetHistoryPayload> &setHistoryActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FSetHistoryPayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FSetHistoryPayload> {
        return rtk::createAction<FSetHistoryPayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV3B0B4D32B10F));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FNPCActionReceivedPayload> & actionReceivedActionCreator()
 */
...
actionReceivedActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FNPCActionReceivedPayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FNPCActionReceivedPayload> {
        return rtk::createAction<FNPCActionReceivedPayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV5C5389EFC698));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FBlockActionPayload> & blockActionActionCreator()
 */
...
blockActionActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FBlockActionPayload>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FBlockActionPayload> {
        return rtk::createAction<FBlockActionPayload>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV8C501347F736));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FString> &clearBlockActionCreator()
 */
inline const rtk::ActionCreator<FString> &clearBlockActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FString>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FString> {
        return rtk::createAction<FString>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV73C697943CC7));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline const rtk::ActionCreator<FString> &removeNPCActionCreator()
 */
inline const rtk::ActionCreator<FString> &removeNPCActionCreator() {
  static const func::Lazy<rtk::ActionCreator<FString>> ActionCreator =
      func::lazy([]() -> rtk::ActionCreator<FString> {
        return rtk::createAction<FString>(TEXT(FORBOCAI_SDK_AUTHORED_STRINGV00BBABFA019A));
      });
  return func::eval(ActionCreator);
}
 ...
 * @fn inline rtk::AnyAction setNPCInfo(const FNPCInternalState &Info)
 */
 ...
 * @fn inline rtk::AnyAction setActiveNPC(const FString &Id)
 */
 ...
 * @fn inline rtk::AnyAction setNPCState(const FString &Id, const FAgentState &State)
 */
 ...
 * @fn inline rtk::AnyAction updateNPCState(const FString &Id, const FAgentState &Delta)
 */
 ...
 * @fn inline rtk::AnyAction addToHistory(const FString &Id, const FString &Role, const FString &Content)
 */
 ...
 * @fn inline rtk::AnyAction setHistory(const FString &Id, const TArray<FNPCHistoryEntry> &History)
 */
 ...
 * @fn inline rtk::AnyAction actionReceived(const FString &Id, const FAgentAction &Action)
 */
 ...
 * @fn inline rtk::AnyAction blockAction(const FString &Id, const FString &Reason)
 */
 ...
 * @fn inline rtk::AnyAction clearBlock(const FString &Id)
 */
 ...
 * @fn inline rtk::AnyAction removeNPC(const FString &Id)
 */
