...
/** User Story: As a core ecs domain consumer, I need to invoke find parent domain key through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline func::Maybe<DomainPathKey> findParentDomainKey(const FPath &Path) */
...
/** User Story: As a core ecs domain consumer, I need to invoke update domain node through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FDomainRegistryTransform updateDomainNode(const DomainPathKey &Key, FDomainNodeTransform Transform) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain child through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainChild(const DomainPathKey &Child, const FNode &Node) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain component schema through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainComponentSchema(const ComponentType &Type, const FNode &Node) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain capability through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainCapability(const FString &Name, const FNode &Node) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain system through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainSystem(const SystemName &Name, const FNode &Node) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain resource through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainResource(const ResourceName &Name, const FNode &Node) */
...
/** User Story: As a core ecs domain consumer, I need to invoke append domain event through a stable signature so the core ecs domain workflow remains explicit and composable. @fn inline FNode appendDomainEvent(const EventType &Type, const FNode &Node) */
...
/**
 * @fn inline FGraph registerDomain(const FRegisterDomainRequest &Request)
 ...
 * User Story: As a core ecs domain consumer, I need to invoke register domain through a stable signature so the core ecs domain workflow remains explicit and composable.
 */
...
/**
 * @fn inline FGraph registerDomainPath(const FRegisterDomainPathRequest &Request)
...
/**
 * @fn inline FGraph registerDomainPaths(FRegisterDomainPathsRequest Request)
...
/**
 * @fn inline FGraph registerDomainPathDeclarations( FGraph Registry, std::initializer_list<FPathRegistration> Declarations)
...
/**
 * @fn inline FGraph registerComponentSchema(const FRegisterComponentSchemaRequest &Request)
...
/**
 * @fn inline FGraph registerCapabilitySpec(const FRegisterCapabilitySpecRequest &Request)
...
/**
 * @fn inline FGraph registerSystemSpec(const FRegisterSystemSpecRequest &Request)
...
/**
 * @fn inline FGraph registerResourceSpec(const FRegisterResourceSpecRequest &Request)
...
/**
 * @fn inline FGraph registerResource(const FRegisterResourceSpecRequest &Request)
...
/**
 * @fn inline FGraph registerEventSpec(const FRegisterEventSpecRequest &Request)
...
/**
 * @fn inline FGraph registerEventType(const FRegisterEventSpecRequest &Request)
...
/**
 * @fn inline FGraph createDomainRegistry(const TArray<FPathRegistration> &Registrations)
