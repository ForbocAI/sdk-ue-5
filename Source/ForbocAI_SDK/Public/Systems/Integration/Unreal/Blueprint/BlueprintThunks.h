...
#include "BlueprintThunks.generated.h"
...
public:
   ...
   * ---- Ghost ----
   * User Story: As a maintainer, I need this note so the surrounding code intent stays clear during maintenance and debugging.
   * @fn static FString startGhost(const FString &TestSuite, int32 Duration)
   */

  UFUNCTION(BlueprintCallable, Category = "ForbocAI|Ghost")
  static FString startGhost(const FString &TestSuite, int32 Duration);
