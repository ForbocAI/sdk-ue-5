...
inline FCLIGhostState readCliGhostState() {
  ...
  return {
      ...
      DataAdapters::ReadStringField(Ghost, TEXT("identity")),
      DataAdapters::ReadStringField(Ghost, TEXT("runtime")),
      DataAdapters::ReadStringField(Ghost, TEXT("suite")),
      ...
      DataAdapters::ReadStringField(Ghost, TEXT("verdict")),
      DataAdapters::ReadStringField(Ghost, TEXT("coverage")),
      DataAdapters::ReadStringField(Ghost, TEXT("result")),
      DataAdapters::ReadStringField(Ghost, TEXT("metric")),
      DataAdapters::ReadStringField(Ghost, TEXT("evidence")),
      DataAdapters::ReadStringField(Ghost, TEXT("integrity")),
      DataAdapters::ReadStringField(Ghost, TEXT("exploration")),
      DataAdapters::ReadStringField(Ghost, TEXT("evidenceDimensions")),
      DataAdapters::ReadStringField(Ghost, TEXT("evaluationDimensions")),
      DataAdapters::ReadStringField(Ghost, TEXT("dimensionSeparator")),
      DataAdapters::ReadStringField(Ghost, TEXT("summary")),
      ...
      DataAdapters::ReadStringField(Ghost, TEXT("historyRuntime")),
