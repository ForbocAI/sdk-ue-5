...
#include "Components/API/Endpoints/Configuration/EndpointsConfigurationTypes.h"
...
inline FEndpointConfigurationData readEndpointConfigurationData() {
  ...
  return {
      ...
      {DataAdapters::ReadStringField(Names, TEXT("getApiStatus")),
       ...
       DataAdapters::ReadStringField(Names, TEXT("postGhostProcess")),
       DataAdapters::ReadStringField(Names,
                                     TEXT("postGhostNpcGenerateAttribute")),
...
inline TArray<FString> endpointNames(const FEndpointNameData &Names) {
  return {Names.GetApiStatus,
          ...
          Names.PostGhostRun,
          Names.PostGhostProcess,
          Names.PostGhostNpcGenerateAttribute,
