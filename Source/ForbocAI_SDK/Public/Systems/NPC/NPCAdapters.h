...
inline FAgentState updateNPCStateLocally(const FAgentState &Current,
  ...
  return (Delta.JsonData.IsEmpty() || Delta.JsonData == TEXT(FORBOCAI_SDK_AUTHORED_STRINGVF54CAD9838EB))
             ? Current
         : (Current.JsonData.IsEmpty() || Current.JsonData == TEXT(FORBOCAI_SDK_AUTHORED_STRINGVF54CAD9838EB))
             ? Delta
             : [&]() -> FAgentState {
        ...
        static void apply(const TSharedPtr<FJsonObject> &Source,
          ...
          Index >= FieldNames.Num()
              ...
              : (Destination->SetField(
                 ...
                 apply(Source, Destination, FieldNames, Index + FORBOCAI_SDK_AUTHORED_NUMBERV0063C33F45B4), void());
        }
      };
      MergeFields::apply(DeltaJson, CurrentJson, Keys, FORBOCAI_SDK_AUTHORED_NUMBERV60732C8368BA);
      FString MergedJson;
