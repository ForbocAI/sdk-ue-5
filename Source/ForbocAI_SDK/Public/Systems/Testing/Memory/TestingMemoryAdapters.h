...
#include "Components/Testing/Memory/TestingMemoryTypes.h"
...
ReadMemoryTestItem(const TSharedPtr<FJsonObject> &Object) {
  ...
  return TypeFactory::MemoryItem(
      ...
      DataAdapters::ReadInt64Field(Value, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV128D5D369032)));
}
  ...
  static const FMemoryContractTestFixtures Fixtures = []() {
    ...
    return FMemoryContractTestFixtures{
        ...
        {DataAdapters::ReadStringField(Record, TEXT("id")),
         ...
         DataAdapters::ReadInt64Field(Record, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV128D5D369032))},
