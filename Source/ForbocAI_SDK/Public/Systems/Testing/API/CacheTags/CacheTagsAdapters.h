...
#include "Components/Testing/API/CacheTags/CacheTagsTypes.h"
...
inline FCacheTagValues ReadTags(
  ...
  return {ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV62BC7243C9C2)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGVA62E687BAD00)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGVDF686F32CCCC)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV10CB016FAA00)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV155399803247)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGVFFCEBD454C3E)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV8C4A7D4C3008)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGVED5418A84438)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGV074E45F591B2)),
          ReadTag(Tags, TEXT(FORBOCAI_SDK_AUTHORED_STRINGVE7F65FD3BAD4), false)};
}
