  ...
  static const FProcessContractData Data = []() {
    ...
    return FProcessContractData{
        ...
        {DataAdapters::ReadStringField(Tape, TEXT("observation")),
         ...
         DataAdapters::ReadStringField(Tape, TEXT("samplerProfile")),
        ...
        {DataAdapters::ReadStringField(InstructionTypes,
         ...
         DataAdapters::ReadStringField(InstructionTypes,
                                       TEXT("queryVector")),
         DataAdapters::ReadStringField(InstructionTypes, TEXT("decision")),
         DataAdapters::ReadStringField(InstructionTypes, TEXT("reasoning")),
         DataAdapters::ReadStringField(InstructionTypes, TEXT("finalize"))},
        {DataAdapters::ReadStringField(ResultTypes, TEXT("identifyActor")),
         DataAdapters::ReadStringField(ResultTypes, TEXT("queryVector")),
         DataAdapters::ReadStringField(ResultTypes, TEXT("decision")),
         DataAdapters::ReadStringField(ResultTypes, TEXT("reasoning"))},
