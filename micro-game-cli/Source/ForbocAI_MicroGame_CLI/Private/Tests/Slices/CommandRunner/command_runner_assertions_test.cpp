...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMicroGameCommandRunnerOutputAssertionsTest,
 ...
 * @fn bool FMicroGameCommandRunnerOutputAssertionsTest::RunTest( const FString &Parameters)
 */
bool FMicroGameCommandRunnerOutputAssertionsTest::RunTest(
