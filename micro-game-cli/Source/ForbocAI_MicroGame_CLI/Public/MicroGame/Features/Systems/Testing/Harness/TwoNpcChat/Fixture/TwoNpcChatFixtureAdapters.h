...
#include "MicroGame/Features/Components/Testing/Harness/TwoNpcChat/Fixture/TwoNpcChatFixtureTypes.h"
...
inline const FTwoNpcChatTestingData &TwoNpcChatTestingData() {
  static const FTwoNpcChatTestingData Data = []() {
    ...
    Value.Labels = {
        ...
        DataAdapters::ReadStringField(Labels, TEXT("identityTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("recallToken")),
        DataAdapters::ReadStringField(Labels, TEXT("decideTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("memoryTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("typedMemoryTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("lineTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("thoughtTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("displayNameTokens")),
        DataAdapters::ReadStringField(Labels, TEXT("typedMemories")),
