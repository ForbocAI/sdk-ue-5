...
#include "MicroGame/Features/Systems/Quality/Report/ReportTypes.h"
#include "MicroGame/Features/Systems/Quality/Report/Serialization/SerializationAdapters.h"

namespace MicroGame {
namespace QualityReportAdaptersDetail {

/** User Story: As a portable micro-game host, I need report paths composed from authored segments and the active Unreal project root. @fn inline FString reportPath(const TArray<FString> &Segments) */
