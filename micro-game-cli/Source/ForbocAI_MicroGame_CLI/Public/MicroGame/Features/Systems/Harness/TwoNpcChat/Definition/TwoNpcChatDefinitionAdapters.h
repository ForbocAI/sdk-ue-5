...
inline const FTwoNpcChatConfig &TwoNpcChatConfig() {
  static const FTwoNpcChatConfig Data = []() {
    ...
    Config.SceneAttribute =
        DataAdapters::ReadStringField(Root, TEXT("sceneAttribute"));
    ...
    Config.IdentityUpdateCommand =
        DataAdapters::ReadStringField(Root, TEXT("identityUpdateCommand"));
    Config.RecallCommand =
        DataAdapters::ReadStringField(Root, TEXT("recallCommand"));
    ...
    Config.TypedMemoryStoreCommand =
        DataAdapters::ReadStringField(Root, TEXT("typedMemoryStoreCommand"));
    Config.SceneMemoryType =
        DataAdapters::ReadStringField(Root, TEXT("sceneMemoryType"));
    Config.RelationshipMemoryType =
        DataAdapters::ReadStringField(Root, TEXT("relationshipMemoryType"));
    Config.AttributeMemoryTypes = DataAdapters::ReadStringMap(
        DataAdapters::ReadObjectField(Source, TEXT("attributeMemoryTypes")));
    Config.ValueField =
        DataAdapters::ReadStringField(Root, TEXT("valueField"));
    Config.ValueType =
        DataAdapters::ReadStringField(Root, TEXT("valueType"));
    ...
    Config.ThoughtFormat =
        DataAdapters::ReadStringField(Root, TEXT("thoughtFormat"));
    Config.TitleFormat =
        DataAdapters::ReadStringField(Root, TEXT("titleFormat"));
    Config.RoleAttribute =
        DataAdapters::ReadStringField(Root, TEXT("roleAttribute"));
    Config.OutputLineSeparator =
        DataAdapters::ReadStringField(Root, TEXT("outputLineSeparator"));
    Config.BlankLine =
    ...
    Config.UnavailablePrefix =
        DataAdapters::ReadStringField(Root, TEXT("unavailablePrefix"));
    Config.CommandFailed =
        DataAdapters::ReadStringField(Root, TEXT("commandFailed"));
    Config.ContextQuote =
        DataAdapters::ReadStringField(Root, TEXT("contextQuote"));
    Config.DebugHeader =
        DataAdapters::ReadStringField(Root, TEXT("debugHeader"));
    Config.DebugFooter =
        DataAdapters::ReadStringField(Root, TEXT("debugFooter"));
    Config.DebugPromptsEnvKey =
        DataAdapters::ReadStringField(Root, TEXT("debugPromptsEnvKey"));
    Config.DebugPromptsEnvValue =
        DataAdapters::ReadStringField(Root, TEXT("debugPromptsEnvValue"));
    Config.Tokens = {
        ...
        DataAdapters::ReadStringField(Tokens, TEXT("thought")),
        DataAdapters::ReadStringField(Tokens, TEXT("memory")),
        DataAdapters::ReadStringField(Tokens, TEXT("turn")),
        DataAdapters::ReadStringField(Tokens, TEXT("role")),
        DataAdapters::ReadStringField(Tokens, TEXT("type")),
