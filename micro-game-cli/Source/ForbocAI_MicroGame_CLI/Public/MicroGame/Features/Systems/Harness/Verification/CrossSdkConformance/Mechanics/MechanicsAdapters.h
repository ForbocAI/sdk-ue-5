...
/** User Story: As a selector verifier, I need terminal and scenario interactions decoded from authored data so the mechanics test contains behavior rather than content. @fn inline CrossSdkConformance::FMechanicsVerificationData ReadMechanics(const TSharedRef<FJsonObject> &Root) */
inline CrossSdkConformance::FMechanicsVerificationData
ReadMechanics(const TSharedRef<FJsonObject> &Root) {
  ...
  CrossSdkConformance::FMechanicsVerificationData Data;
