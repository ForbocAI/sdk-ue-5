...
/** User Story: As a focused micro-game mode, I need API-owned scenarios projected to one required CLI command group without duplicating command data. @fn inline TArray<FScenarioStep> SelectScenarioStepsByCommandGroup( const FScenarioSliceState &State, const FString &Group) */
