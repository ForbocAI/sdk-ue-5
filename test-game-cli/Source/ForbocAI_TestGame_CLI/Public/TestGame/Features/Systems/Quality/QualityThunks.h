...
#include "TestGame/Features/Systems/Quality/Command/QualityCommandAdapters.h"
#include "TestGame/Features/Systems/Quality/Metadata/MetadataAdapters.h"
#include "TestGame/Features/Systems/Quality/QualityActions.h"
...
/** User Story: As a release reviewer, I need setup failures terminate the quality run explicitly without creating passing empty metrics. @fn inline void failEvaluation(FTestGameStore &Store, const FString &Error) */
inline void failEvaluation(FTestGameStore &Store, const FString &Error) {
...
inline void runQualityProbes(
    ...
    const FQualityModelMetadata &Metadata, FTestGameStore &Store,
    const FQualityRunDependencies &Dependencies, int32 Index) {
  Index >= Probes.Num()
      ? void()
      : [&]() {
...
inline void runQualityEvaluation(
    FTestGameStore &Store, const FQualityRunDependencies &Dependencies) {
