...
#include "TestGame/Features/Systems/Chat/ChatTypes.h"

namespace TestGame::ChatAdapters {
...
/** User Story: As a test-game package, I need one immutable chat contract shared by selectors and tests. @fn inline const FChatData &ChatData() */
