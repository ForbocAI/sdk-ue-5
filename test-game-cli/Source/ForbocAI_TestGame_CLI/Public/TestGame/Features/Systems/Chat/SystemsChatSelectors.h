...
#include "Core/fp.hpp"
#include "TestGame/Features/Systems/Chat/ChatAdapters.h"
...
namespace TestGame::ChatSelectors {
...
/** User Story: As a test-game operator, I need one ordered conversation projected from root-owned live quality evidence. @fn inline FChatTranscript SelectChatTranscript(const func::Maybe<FQualityReport> &Evidence) */
