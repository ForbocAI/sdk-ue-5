...
/** User Story: As an RTK verifier, I need player and bridge cases decoded from the same architecture contract used by TS so store behavior remains comparable. @fn inline Verification::FRtkVerificationData ReadRtk(const TSharedRef<FJsonObject> &Root) */
inline Verification::FRtkVerificationData
ReadRtk(const TSharedRef<FJsonObject> &Root) {
  ...
  Verification::FRtkVerificationData Data;
